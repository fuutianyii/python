...
def insert_caseSchoolXsxxXsjzxx():
    ...
    # 读取xls（绝对路径）
    data=pd.read_excel(io=r'C:/Users/FTY/Downloads/2022教师认定.xlsx',header=0)
    data=data.values
    for i in data:
        url="http://zzxx.jse.edu.cn/msc-api/api/tour/caseSchoolJsxxJsrd/save"
        ...
        header={"Host": "zzxx.jse.edu.cn",
            ...
            "Userid": "675375428cfefb849256a6fe3383fe02",
            "Token": "675375428cfefb849256a6fe3383fe02",
